...
In contrast, interference between helicity amplitudes of the $B_{(s)}$ and $\bar B_{(s)}$ decays is directly sensitive to the photon polarization. The interference can be measured by using time-dependent $\CP$-asymmetries in $B\to V\gamma$, \td{JZ: unclear, please improve:} or those induced by the width-differences, 
%which have been 
