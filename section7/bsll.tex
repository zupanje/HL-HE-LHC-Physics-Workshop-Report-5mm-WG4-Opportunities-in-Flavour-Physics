...
\Blu{There is an additional leptoquark that has been identified as possible explanation of the rare $B$-decay anomalies. With the appropriate couplings, the scalar-singlet leptoquark $S_1 = (3,1,-1/3)$ can contribute to $b \to s \ell \ell$ transitions through 1-loop box diagrams~\cite{Bauer:2015knc}. At the tree level, $S_1$ contributes to the neutrino modes $B \to K^{(*)} \nu \bar \nu$, and at the loop level to $B_s$ mixing as well as to $Z \to \mu\mu$. If $S_1$ is responsible for the anomalies, NP effects in these processes are expected to be close to the current experimental sensitivities. }
