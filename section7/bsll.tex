...
The SM contributes only to the $O_{9,10}$ operators while BSM can contribute also to $O_{9,10}^\prime$ and additional semi-leptonic operators involving scalar and tensor structures~\cite{}. 
