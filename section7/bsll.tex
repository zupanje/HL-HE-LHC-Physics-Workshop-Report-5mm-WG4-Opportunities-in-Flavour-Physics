...
operators with Wilson coefficients (WCs) that encapsulate all SM weak and heavy NP effects. Thus all observables can be calculated in full generality (model-independently) in terms of these WCs and of QCD hadronic matrix elements. The relevant operators for $b\to s$ transitions at low-energies in the SM is
\begin{equation}
\label{eq:Heff}
  {\cal{H}}_{\rm eff}^{\rm SM}=
  \frac{4 G_F}{\sqrt{2}}\sum_{p=u,c}\lambda_{ps}\left(C_1 \mathcal{O}_1^p+C_2 O_2^p +\sum_{i=3}^{10} C_i  O_i\right),
\end{equation}
with $\lambda_{ps}=V_{pb}^{} V_{p s}^\ast$. The $O_{7}$ and $O_{9,10}$ are the electromagnetic penguin and the semileptonic operators, respectively, and $O_{1,2}^p$,  $O_{3,\ldots,6}$, and $O_{8}$ are the ``current-current'', ``QCD-penguins'' and ``chromo-magnetic'' operators, respectively, which require of an electromagnetic interaction to contribute to the $b\to s\ell\ell$ transition. 
The effect of BSM enters through the WCs $C_1,\ldots,C_{10}$ or by means of chirally-flipped ($b_{L(R)}\to b_{R(L)}$) versions of these operators $O_{7,\ldots, 10}'$, and also four scalar and two tensor operators~\cite{Bobeth:2007dw}. For the purpose of this Section, the piece of the effective hamiltonian relevant for the interpretation of the $b\to s$ data are
%
\begin{align}
&O_{7\gamma}^\prime&=\frac{e}{16\pi^2}(\bar s\sigma_{\mu\nu}P_{R(L)} b)F^{\mu\nu},\\
O_9^\ell &=\frac{\alpha_{\rm em}}{4\pi}
(\bar{s} \gamma_{\mu} P_{L} b)(\bar{\ell} \gamma^\mu \ell)\,,
& \!\!\!\!\!
O_9^{\prime \, \ell} &=\frac{\alpha_{\rm em}}{4\pi}
(\bar{s} \gamma_{\mu} P_{R} b)(\bar{\ell} \gamma^\mu \ell)\,,\label{eq:O9}
\\
O_{10}^\ell &=\frac{\alpha_{\rm em}}{4\pi}
(\bar{s} \gamma_{\mu} P_{L} b)( \bar{\ell} \gamma^\mu \gamma_5 \ell)\,,
& \!\!\!\!\!
O_{10}^{\prime \, \ell} &=\frac{\alpha_{\rm em}}{4\pi}
