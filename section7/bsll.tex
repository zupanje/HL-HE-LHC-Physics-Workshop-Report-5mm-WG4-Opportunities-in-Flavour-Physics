...
in the whole \td{JZ:high?} low-$q^2$ region is typically considered in the global fits. The $q^2$ spectrum can be used to give estimates and test models for the intrinsically nonperturbative ``duality violating'' effects. Currently, these analyses are carried out within the
