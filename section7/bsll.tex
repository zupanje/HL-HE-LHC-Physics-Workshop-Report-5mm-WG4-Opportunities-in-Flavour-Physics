In this section we discuss the status of the interpretation of $b\to s$ transitions within the SM and BSM, the prospects from future sensitivities at the LHC, and the complementarity with
...
For the purpose of this Section, the piece of the effective hamiltonian relevant for the interpretation of the $b\to s$ data in terms of short-distance physics is
%
\begin{equation}
\label{eq:Heff}
...
The SM contributes only to the $O_{9,10}$ operators while BSM can contribute also to $O_{9,10}^\prime$ and additional semi-leptonic operators involving scalar and tensor structures. 
...
On the exclusive side, the cleanest from the theory perspective are the purely leptonic decays $B_s\to \ell^+ \ell'^-$. Up to QED corrections~\cite{1708.09152}, all QCD effects are contained in the decay constant $f_{B_s}=224(5)$~MeV~\cite{Aoki:2016frl}, which is precisely and reliably computed in the lattice.
