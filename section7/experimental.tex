...
The expected precision of an unbinned LHCb-only determination of $P_5^{\prime}$ in the SM and in Scenarios~I and II is illustrated in Fig.~\ref{fig:penguin:P5primeUnbinned}, where we have followed the theoretical approches in Refs.~\cite{Hurth:2017sqw,Chrzaszcz:2018yza} for the predictions. 
