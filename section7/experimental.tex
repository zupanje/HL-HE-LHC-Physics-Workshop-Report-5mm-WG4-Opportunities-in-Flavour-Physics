...
The corresponding total and statistical only uncertainties on $P'_5$  are shown in the two lower pads of Fig.~\ref{fig:CMSP5presults}.
 In addition, with the foreseen HL-LHC statistics, CMS will also have the capability to perform a full angular analysis of the \decay{\Bz}{\Kstarz\mumu} decay mode.
