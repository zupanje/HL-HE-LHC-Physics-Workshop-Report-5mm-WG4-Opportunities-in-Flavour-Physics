...
bins of \qsq or using a \qsq-unbinned approach~\cite{Hurth:2017sqw}; LHCb foresees to achieve around 440\,000 fully reconstructed \decay{\Bz}{\Kstarz\mumu} decays, CMS around 700\,000 excluding the $q^2$ range 
 ...
 In CMS the expected $B^0$ signal yield per each $q^2$ bin is measured using a full simulation of the upgraded detector.
...
The projected statistical uncertainty on the ${P'_5}$  parameter measurement at 300 and 3000 fb$^{-1}$ is obtained scaling the statistical uncertainty measured in Run 1 
 ...
 \cite{Sirunyan:2017dhj}; uncertainties which depend on the available amount of data are scaled by the ratio of the square root 
of the number of events, those associated to the limited number of simulation events are neglected, under the assumption that sufficiently large simulation samples  will be available by the time of future analyses, and the remaining sources are assumed to be reduced by a factor of 2 in higher statistics scenarios. 
...
%Uncertainties concerning the simulation mismodeling,  efficiency determination,
 ...
 %of the number of events. The uncertainty related to the limited number of simulation events is neglected, under the assumption that sufficiently large simulation samples  will be available by the time of future analyses.
  The resulting $P_5'$ uncertainties in the $q^2$ bins are estimated to improve up to a factor of  xx and 15 in the 300 and 3000 fb$^{-1}$ scenario respectively, compared to those quoted in the Run~1 analysis \cite{CMS-PAS-FTR-18-033}. 
