...
sPlot technique \cite{splot} and fit to an exponential function, convolved with a Gaussian resolution function reflecting the expected decay time resolution. %{\bf\color{red}[Consistent notation e.g. $\mathrm{B^0_s}$ %vs. $B_s^0$ or $B_s$???]}
