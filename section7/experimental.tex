...
Systematic uncertainties are treated slightly differently in the projections of the three experiments. All three experiments assume the uncertainty associated to the normalization modes branching fractions to be 3\%, but while ATLAS conservatively assumes in the HL-LHC projections that the $f_s/f_d$ uncertainty will be at the same level as previously used: 8.3\%, LHCb assumes this uncertainty to be 5.8\% whilst CMS projects it to lower to 3.5\%. 
...
\begin{table}
  ...
  \begin{tabular}{ l c c c c c }
   ...
   Experiment & Scenario & stat \% & stat + syst \% & stat \% & stat + syst \% \\
    \hline
    LHCb   & 23\invfb          &       &   8.2  &       &  34       \\
    LHCb   & 300\invfb         &       &  4.4  &       &  10       \\
     CMS   & 300\invfb         &       &   12 &       & 46  \\
     CMS   & 3 \invab          &       &   7  &       & 16  \\
...
The HL-LHC projected relative statistical uncertainty of the current LHCb analysis is 1.8\%.  At the end of the Upgrade II data taking period, LHCb assume to achieve a systematic uncertainty on ${\cal B}(\decay{\Bs}{\mumu})$ of about 4\%, which
...
\caption{The CMS binned maximum likelihood fit to the decay time distribution for the Phase-II scenario}
