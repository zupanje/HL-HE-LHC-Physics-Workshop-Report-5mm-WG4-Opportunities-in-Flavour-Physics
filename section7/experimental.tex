 ...
 \begin{figure}[htbp]
   \begin{center}
    \includegraphics[width=0.5\textwidth]{\main/section7/figures/ATLASmass.pdf}
       \caption{Comparison of the ATLAS invariant mass spectra for simulated $B^0_s \to \mu^+\mu^-$ events with the current (Run~2) and upgraded (ITk) detectors. A vertical line at the $B_d$ mass value is drawn to visualize the $B_s$-$B_d$ signals separation.}
...
\begin{figure}[htbp]
  \centering  
  \includegraphics[width=0.6\textwidth]{\main/section7/figures/plot_preliminary_x15.pdf}
  \includegraphics[width=0.6\textwidth]{\main/section7/figures/plot_preliminary_x60.pdf}
  \includegraphics[width=0.6\textwidth]{\main/section7/figures/plot_preliminary_x75.pdf}
   ...
   \begin{center}
    \includegraphics[width=0.45\textwidth]{\main/section7/figures/CMS_mass_barrel.pdf}
     \includegraphics[width=0.45\textwidth]{\main/section7/figures/CMS_mass_forward.pdf}
       \caption{CMS $B_{d.s} \to \mu^+\mu^-$ invariant mass distributions with the fit projection overlaied, corresponding to an
...
The CMS expected $\mathrm{B^0}$ signal yield per each $q^2$ bin is measured on the Phase II MC sample.
