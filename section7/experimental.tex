...
The two lower pads represent the  statistical (upper pad) and total (lower pad)  uncertainties with the finer $q^2$ binning. (taken from \cite{CMS-PAS-FTR-18-033}).} 
...
The $P_5'$ total uncertainties in the $q^2$ bins are estimated to improve up to a factor of 15 in the  3000 fb$^{-1}$ scenario, compared to those quoted in the Run~1 analysis.
An extrapolation is also performed to 300 fb$^{-1}$ integrated luminosity following the same analysis method; an improvement of up to a factor of 7 is estimated with respect to the Run~1 analysis
\cite{CMS-PAS-FTR-18-033}.
