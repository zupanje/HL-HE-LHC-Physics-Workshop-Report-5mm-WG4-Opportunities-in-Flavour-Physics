...
% PID 2\%
% track reco 2\%
The current systematic uncertainty is dominated by sources external to the analysis, such as the relative uncertainty associated with the $b$-quark fragmentation probability ratio, $f_s/f_d$~\cite{fsfd}, followed by the branching fractions of the normalisation modes and less significant systematics arising from internal analysis effects (e.g., $2\%$ each from particle identification and track reconstruction in the case of LHCb, individual  efficiencie in the case of ATLAS and CMS). 
