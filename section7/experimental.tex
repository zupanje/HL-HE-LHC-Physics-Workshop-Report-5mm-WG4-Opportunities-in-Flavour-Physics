...
The current CMS projection \cite{CMS-PAS-FTR-18-013}, compared to the previous Run-I analysis \cite{CMSRun1},  includes a more advanced UML fit and an improved muon identification algorithm. 
...
bins of \qsq or using a \qsq-unbinned approach~\cite{Hurth:2017sqw}; LHCb foresees to achieve around 440\,000 fully reconstructed \decay{\Bz}{\Kstarz\mumu} decays, CMS \cite{CMS-PAS-FTR-18-033} around 700\,000 excluding the $q^2$ range 
 ...
 The CMS expected $\mathrm{B^0}$ signal yield per each $q^2$ bin is measured on the Phase 2 Monte Carlo sample.
...
The projections for the measurement of $\mathrm{P'_5}$ versus $q^2$ are shown in Fig.~\ref{fig:CMSP5presults}, together with the measurements from the Run 1 analysis.
 \begin{figure}[htbp]
  \begin{center}
