...
Figure~\ref{fig:penguin:DeltaC} shows that an upgraded \lhcb detector will enable such decays to be used to discriminate between different NP models, for example separating between Scenarios~I and II~\cite{Mauri:2018vbg}. 
...
\begin{figure}[t!]
\centering
\includegraphics[width=0.49\textwidth]{ellipses_DeltaC.pdf}
\caption{
  Constraints on the difference in the $C_9$ and $C_{10}$ Wilson coefficients from electron and muon modes with the Run~3 and \upgradetwo data sets.
