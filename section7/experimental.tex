...
At the end of the Upgrade II data taking period, LHCb assumes to achieve an overall uncertainty on ${\cal B}(\decay{\Bs}{\mumu})$ of about $4.4$\%, which
...
The corresponding total and statistical only uncertainties on $P'_5$  are shown in the two lower pads of Fig.~\ref{fig:CMSP5presults}.
