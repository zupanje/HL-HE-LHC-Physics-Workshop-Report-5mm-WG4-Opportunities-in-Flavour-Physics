...
\begin{table}
  \centering
  \caption{Projected ATLAS, CMS and LHCb uncertainty on $\cal{B}$$(B^0_s \to \mu^+ \mu^-)$ and $\cal{B}$$(B^0 \to \mu^+ \mu^-)$.The HL-LHC scenario corresponds to and integrated luminosity of 300 fb$^{-1}$ for LHCb and 3 ab$^{-1}$ for ATLAS and CMS. 
