...
A key contribution of the HL-LHC data sets will be a comprehensive global picture of rare and (semi)-leptonic quark transitions. This has value whether or not the current ``flavour anomalies'' are confirmed with Run~2 or Run~3 LHC data. If the improvements on statistically limited observables, $R_{K^{(*)}}$ and \RDb,  
%which 
