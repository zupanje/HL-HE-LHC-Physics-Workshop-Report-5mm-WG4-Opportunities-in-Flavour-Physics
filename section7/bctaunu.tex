...
\end{equation}
Combining this with the inclusive measurement $\text{Br}[B \to X_c e \nu] = (10.65 \pm 0.16)\%$~\cite{Amhis:2016xyh} implies $\text{Br}[B \to X_c \tau \nu] = (2.38 \pm 0.05)\%$. This is in good agreement with the LEP measurement $\text{Br}[b \to X \tau \nu]= 2.41 \pm 0.23$~\cite{PDG2018}, where $X$ can be any multibody state. However, the present measurements for $\text{Br}[B \to D \tau \nu] + \text{Br}[B \to D^* \tau \nu] = 2.71 \pm 0.18$, when further combined with the SM predictions for $\text{Br}[B \to D^{**}\tau\nu]$, implies $\text{Br}[B \to X_c \tau \nu]  \gtrsim 3\%$, already well in excess of the prediction for the semitauonic inclusive process. Given this tension, and since measurement of the inclusive process would involve both different theory uncertainties and different systematics compared to the exclusive modes, direct measurement of $B \to X_c\tau\nu$ is of high interest in further understanding the $R(D^{(*)})$ anomalies. 
}
