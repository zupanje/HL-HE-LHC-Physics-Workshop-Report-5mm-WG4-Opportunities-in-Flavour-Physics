...
We turning next to the bag parameter $B_K$, relevant for the theoretical prediction
...
%Concerning the phenomenological implications of $B_K$ however, t
The main hadronic
...
elements. The recent (\td{what doe this refer to:}not accounted for yet) and projected progress on the
...
%Moving now to momentum-dependent hadronic parameters, 
...
The state of art for the form factor determinations is 
%is concerned, we consider the 
