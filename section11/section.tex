...
\caption{Current estimates and projections for lattice QCD determinations of hadronic inputs. In the fourth column we quote the error corresponding to the published value in the second column and,
  in parenthesis, the error coming calculations that either are not published yet or are not included in the FLAG-2016 averages. See text for further explanations.}
\label{table:Proj}
\end{sidewaystable}
\end{center}
