...
\item In the fourth column we quote the error corresponding to the published value in the second column and,
  in parenthesis, the error coming from a couple of most recent calculations that are not published yet, but have
...
$f_+^{K\to\pi}(0)$ & $0.9706(27)$ & $N_f=2+1+1$~\cite{Aoki:2016frl} & 0.28\% (0.19\%~\cite{KtopiFNALMILC}\td{missing}) & 0.12\%\\
