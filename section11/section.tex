...
%\begin{center}
%
\hspace*{-1.2cm}\begin{tabular}{ccccc}
\hline\hline
...
\end{small}
\vspace{-0.1cm}
\caption{Current estimate and projections. See text for detailed explanations.}
\label{table:Proj}
\end{table}
