...
\begin{figure}[h]
\centering
\includegraphics[width=0.4\textwidth]{section8/figs/contour_r-L.pdf}
\hspace{3mm}
\includegraphics[width=0.4\textwidth]{section8/figs/contour_r-L_27.pdf}
\hspace{3mm}
...
\begin{figure}[t]
  \vspace{-0.3cm}
\begin{center}{
\includegraphics[width=6cm]{section8/figs/quark-gluon_ROC.pdf}
  \vspace{-0.3cm}
...
\hline 
(t) type & Cuts &\  $\epsilon^{\mathrm t}_{q}$\ &\ $\epsilon^{\mathrm t}_{b}$\ &\ $\epsilon^{\mathrm t}_{c}$\ &\ $\epsilon^{\mathrm t}_{g}$\ \\ \hline\hline
$q$-tagger &$N_{\mathrm SV}=0$ \& $z_{\mathrm max}>0.3$    &  $0.18$ & $0.0031$ & $0.038$ & $ 0.049$ \\
$b$-tagger & $N_{\mathrm SV}>3$     		                          &  $0.0091$ & $0.64$ & $0.09$ & $0.016$ \\ \hline
\end{tabular}
}
\end{center}
...
\begin{figure}[h!]
  \vspace{-0.3cm}
\begin{center}{
\includegraphics[width=6cm]{section8/figs/LHC_Resolved_lep_tops.pdf} 
\vspace{-0.3cm}
...
%
\begin{table}\label{tab:indirectWtb}
\center\small
...
%
Using the above contributions and the current experimental limits \cite{Afach:2015sja,Baker:2006ts,Baron:2013eja}, we obtain the constraints in Table \ref{tab:indirectWtb}.
