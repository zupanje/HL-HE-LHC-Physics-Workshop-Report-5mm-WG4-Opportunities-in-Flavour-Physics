...
The top quark plays a central, often secluded, role in Flavor Physics. It is the only quark with unsuppressed couplings to the Higgs boson and, therefore, it is furnished with a large mass, of the order of the EWSB scale. This singular property makes the top-quark crucial in addressing the Flavor Puzzle (Sec.~\ref{sec:Intro}) and potentially sensitive to BSM addressing it. Large Yukawa couplings lead to large top-loop corrections and the accuracy of theoretical predictions rely on a precise measurements of the top-quark mass. This is important for phenomenology, as in Higgs production and diphoton searches, and has far and profound theoretical consequences related to the stability of the mass of the Higgs, or the stability of the Universe itself (the famous $\Lambda_{\textgoth{Hell}}$). In case of Flavor phenomenology, the top is responsible for the large short-distance contributions to the down-quark FCNCs and, as such, it is essential for the SM predictions and provides a natural conduit for BSM affecting rare $B$-meson and kaon decays. The flavor couplings of the top itself are relevant: They provide direct inputs for the CKM matrix elements or to the structure, and possible $CP$ violation, of the $Wtb$ couplings. They are also directly sensitive to BSM affecting top FCNCs, which are null tests of the SM. 
