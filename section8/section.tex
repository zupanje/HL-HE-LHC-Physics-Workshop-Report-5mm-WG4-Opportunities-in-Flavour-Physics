...
\item[$\bullet$] For single top-quark production through the $tqg$ interaction, we use the best constraints: in the up-quark channel by CMS and in the charm-quark channel by ATLAS. We naively combine them using the numerical value at NLO in QCD for the $t\to jj$ branching fraction provided in Section V.B of Ref.\,\cite{Durieux:2014xla}.
