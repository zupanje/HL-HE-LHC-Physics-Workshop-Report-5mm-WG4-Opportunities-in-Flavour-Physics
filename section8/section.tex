...
missing energy ($E^{\rm miss}_{T}$). The analysis at CMS requires exactly one $b$ and one non-$b$ jet to be present in the final state with the dominant background arising from the $t\bar{t}$+jets
