...
\end{align}
It should be mentioned that, within the SMEFT, gauge invariance links the above vertices to additional interactions, the full forms of the relevant operators are given in Sec.~8.3.
...
\subsection{Global effective-field-theory interpretation of top-quark FCNCs} {\bf\color{red}[Swap this section by previous one]}
...
Starting from and EFT with full $SU(3)_C\times SU(2)_L\times U(1)_Y$ gauge symmetry and matter content of the SM,
