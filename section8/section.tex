...
The LHC as a top-quark factory has the ability to directly probe the $V_{tx}$ matrix elements. In particular, measuring the fractions of $b$-tagged jets in leptonic top decays $t\to Wj$ allows to set a limit on the ratio 
\begin{equation}
