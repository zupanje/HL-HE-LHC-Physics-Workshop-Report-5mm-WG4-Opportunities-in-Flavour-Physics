...
translated into asymmetry constraints (\td{shouldn't there be a minus sign on rhs, see \eqref{eqn:scs_asymm1}?} $A_{\CP}^{ind.} \approx x \sin(\phi)$) by multiplying by the current
...
Since the main limit for these studies comes from the available statistics, excellent prospects are foreseen for the LHCb \upgradeone. 
