...
This corresponds to $\Gamma_{ij} \approx \Gamma^D$, which is not surprising, given that the HQE can successfully explain the large lifetime ratio of charm mesons 
