...
\section[Charm-quark probes of new physics]{Charm-quark probes of new physics\footnote{Author(s) (TH): J. Brod, A. Lenz, S. Fajfer, A. Kagan, L. Silvestrini.}} 
...
$BR(\pi^+ \mu^+ \mu^-)_{I}<  2.5\times 10^{-8}$ for region I, ${q^2 \in [0.0625,0.276]\,{GeV}^2} $, and
    $BR(\pi^+ \mu^+ \mu^-)_{II}  <  2.9 \times 10^{-8}$ for region II, ${q^2 \in [1.56,4.00]{GeV}^2}$~\cite{LHCb-PAPER-2012-051}. 
