...
large $U$-spin violation, e.g. $\epsilon^2 = O(20\%) $ in $\Gamma_2$, cf. \eqref{Uspinamps}, which could be attributed to long-distance duality violation \cite{Jubb:2016mvq}.  One possibility for directly addressing the origin of $U$-spin violation in $\DDbar$ mixing is the second (exclusive) approach mentioned above.
