...
An exception to property (iii) arises in $D^0 \to K_s K_s$, where the leading ``tree-level" decay amplitude enters at $O(\epsilon)$ \cite{Nierste:2015zra}, thus yielding ${\delta \phi_{K_s K_s} /\phi_{2}^\Gamma } = {\mathcal O}(1)$.
