...
\eeq
where $A_f =\langle f | H_{\Delta c=1} | D^0\rangle $ and $\bar A_f =\langle f | H_{\Delta c=1} | \dzbar \rangle $ are the $D^0 \to f$ and $\dzbar \to f$ decay amplitudes, respectively, %$\sum$ denotes a sum over all hadronic states $f$ into which both the $D^0$ and $\bar{D}^0$ can decay, 
$\rho_f$ is the 
...
entering $M_{12}^D$ %are not directly measurable, and 
