...
At ATLAS and CMS the large number of interactions per bunch crossing during the HL-LHC will be a challenge. However, the upgraded detectors will have higher granularity and timing information to mitigate pile-up effects \cite{CMS:TPMTD}\cite{CMS-PAS-FTR-18-012}. 
%Nevertheless, 
...
timing detector \cite{CMS:TPMTD} \cite{CMS-PAS-FTR-18-012} will bring new and unique capabilities to the detectors in the Heavy Flavor sector.
...
Indeed, considering the tenfold increase in the High Level Trigger rates and pile-up mitigation, it could be conceivable to think of dedicated streams of analysis to be performed with the whole 3000 fb$^{-1}$ statistics or in dedicated runs, with minimal impact on the 
high \pt physics.
...
The high \pt searches in ATLAS and CMS will also allow for a program of measurements which are complementary to the low \pt flavour investigations and will help to build a coherent theoretical picture. 
