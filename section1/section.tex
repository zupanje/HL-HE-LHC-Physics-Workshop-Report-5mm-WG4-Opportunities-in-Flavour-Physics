...
charm and kaons, as well as possible FCNC top-quark decays. Measurements of different flavour transitions are important to determine the BSM flavour structure, while measurements of the same quark level transition, but with different initial and final states determine the chiral structure of the BSM model. 
\smallskip
