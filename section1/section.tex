...
\smallskip
{\bf Nonperturbative QCD and its role in flavour physics.} A particular class of theoretical uncertainties are those produced by our incomplete understanding of the dynamics of QCD at low energies. Indeed, flavour transitions are mostly measured in weak decays of hadrons and information on nonperturbative functions such as form factors are needed to extract information on the short-distance physics from the experimental data. The last decade has also witnessed important theoretical progress in the calculation of these hadronic parameters, with refinements within the effective-field-theory approaches exploiting e.g. heavy-quark and/or low-energy perturbative expansions and, specially, with major steps given in the field of lattice QCD. For instance, the theoretical precision in the calculation of nonperturbative quantities which are crucial e.g. for the extraction of the CKM matrix element $|V_{us}|$ or for the interpretation of FCNCs such as $B\to\mu\mu$ have reached the per-mille level.           
