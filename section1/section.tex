...
It is not trivial for ATLAS and CMS to fully exploit this potential: $B$ physics is expected to be 
among the areas that may suffer most heavily from the HL-LHC conditions. This is a consequence of the relatively 
low momenta of typical heavy flavour signatures, and the high pileup which might affect the precision of the measurements.
On the other hand, some projected Phase~2 upgrades of ATLAS and CMS promise good detection potential, good pileup effect mitigation and even -- in some cases -- an improved performance. Examples are the new inner trackers, improvements of the muon systems, topological trigger capabilities, and the possibility to use tracking in the early stages of the trigger chain.
