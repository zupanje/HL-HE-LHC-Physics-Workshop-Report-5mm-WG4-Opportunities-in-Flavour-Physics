...
The estimates in Table~\ref{tab:exclusiveproj} are in agreement with the ATLAS projection for $h\to J/\psi\gamma$~\cite{ATL-PHYS-PUB-2015-043}, which quotes $R_{J/\psi\gamma,ZZ^*}<0.34^{+0.14}_{-0.1}$.
...
Currently, the CMS 13\,TeV search with 35.9\,fb$^{-1}$~\cite{Sirunyan:2017xzt} gives the strongest constrain 
%
\Blu{
\begin{align}
