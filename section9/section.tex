...
In Fig.~\ref{fig:kbkc_couplingdependentBRs} the systematic uncertainties are conservatively kept at current level (dubbed Scenario 1 in WG2 write-up).
%\td{cite WG2}). 
The results for reduced systematic uncertainties (Scenario 2) can be found in WG2 write-up. There is only a minor change in the projected constraints on $\kappa_c, \kappa_b$ compared to Scenario 1. 
