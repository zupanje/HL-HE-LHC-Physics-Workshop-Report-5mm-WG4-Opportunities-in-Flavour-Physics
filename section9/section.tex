...
Fig.~\ref{fig:kbkc_couplingdependentBRs} shows expected one sigma $\kappac, \kappab$ contours from $3000$fb$^{-1}$ global fits to \td{JZ: correct?} $\kappac, \kappab$ and $\kappa_t$ \td{is $/\cg$ also varied? YS: I do not think so}, obtained by extrapolating the measured constraints in Ref.~\cite{CMS:2018hhg}. The fit uses expected differential distributions, obtained by extrapolating the $\sqrt{s}=13\,$TeV $p_T$ distributions in the $\hgg$~\cite{Sirunyan:2018kta} and 
%$\hzztofourl$
...
\td{Projections are missing; YS: there are no official projection for this}
