...
\begin{figure}[t]
	...
	\caption{Summary of the HL-LHC projections discussed in the main text:  from exclusive decays (blue), from Higgs kinematic distributions (purple) and from inclusive constraints (yellow), \vtwo{from off-shell bounds on total decay width (green), from the  $h\to \gamma \gamma$ and  $ZZ$ line shapes (dashed), and from global fits (red).}	
