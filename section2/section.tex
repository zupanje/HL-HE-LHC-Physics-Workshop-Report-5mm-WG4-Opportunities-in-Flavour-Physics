...
\caption{Present (lighter) and future (darker) constraints on the NP scale from the UTfit NP analysis. The right panel shows constraints assuming NP is weakly coupled and enters observables only at one loop, see text for details. }
\label{fig:DF2Lambda}
\end{center}
\end{figure}
