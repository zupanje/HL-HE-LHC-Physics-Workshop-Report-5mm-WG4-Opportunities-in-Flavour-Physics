...
\section[Testing the CKM unitarity]{Testing the CKM unitarity\footnote{Author(s) (TH): J\'er\^ome Charles, Marco Ciuchini,  Olivier Deschamps, S\'ebastien Descotes-Genon, Luca Silvestrini, Vincenzo Vagnoni.}}
\label{sec:metro-CKM}
...
are set to have their errors significantly reduced  by future lattice QCD computations, see Section \ref{sec:lattice}.
...
Advancement in the lattice QCD determination of hadronic matrix elements, used in the extraction of CKM elements, need to go hand in hand with the improved experimental precision. The projections on the expected errors for the most important hadronic matrix elements are  discussed in detail in Section \ref{sec:lattice} with the main results collected in Table \ref{table:Proj}.
%\begin{itemize}
%\item Lattice extrapolations
%\item Issue of isospin and radiative corrections
%\end{itemize}

The accuracy of the projections below will also require an improvement in the understanding of electromagnetic corrections, which for the moment are only partially addressed in theoretical predictions. Further details on the inclusion of QED corrections in lattice predictions are discussed in Section \ref{sec:lattice}.
...
In $\alpha$ extraction the small penguin contributions are avoided using isospin symmetry. The associated theory error on $\alpha$ due to isospin breaking  
