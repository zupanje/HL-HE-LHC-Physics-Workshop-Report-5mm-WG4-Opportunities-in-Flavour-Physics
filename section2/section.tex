...
\section[Testing the CKM unitarity]{Testing the CKM unitarity\footnote{Author(s) (TH): Luca Silvestrini, J\'er\^ome Charles, Marco Ciuchini, Vincenzo Vagnoni, S\'ebastien Descotes-Genon, Olivier Deschamps.}}
\label{sec:metro-CKM}
...
\begin{equation}
A=0.826\pm,0.012,\quad \lambda=0.2250\pm0.0010, \quad \rho=0.152\pm0.014,\quad \eta=0.357\pm 0.010,
\end{equation}
...
%The uncertainties obtained are given in Table~\ref{tab:CKMfitterprojresults}, while the corresponding constraints in the $(\bar\rho,\bar\eta$) plane are shown in Fig.~\ref{fig:CKMfitterglobal}. 
...
\end{equation}
are reported in Fig.  \ref{fig:DF2Lambda}. In left panel in Fig.  \ref{fig:DF2Lambda} the flavour and loop factors were set to $F_i=L_i=1$, i.e., this shows the limits on the mass of NP states that contribute to meson mixing at tree level and couple with ${\mathcal O}(1)$ strength to the corresponding SM fermions. In Fig. \ref{fig:DF2Lambda} right, the flavour factor was set to $F_i=V_{t q_1}V_{t q_2}^*$, and the loop factor to $L_i=\alpha_2/(4\pi)$, with $\alpha_2$ the weak structure constant. That is, the right panel of Fig. \ref{fig:DF2Lambda} shows the reach for masses of NP states that have MFV like couplings to SM fermions and contribute only at one loop level. 
