...
are of similar size, ${\mathcal O}(\lambda^3)$. Fig.~\ref{fig:UTtriangle} shows the standard unitarity triangle (UT), obtained from \eqref{eq:orthog:rel} by rescaling with $V_{cd}V_{cb}^{*}$ the three terms in the orthogonality relation. 
	...
	\begin{tabular}{cccccccc}
		\hline\hline 
		 & $\bar{\rho}$ & $\bar{\eta}$ & $A$ &  $\sin2\beta$ & $\gamma$ & $\alpha$ & $\beta_s$ \\ \hline
			Current & 9\% & 3\% & 1.5\% & 4.5\% & 3\% & 2.5\% & 3\% \\ 
			Phase 1 & 2\% & 0.8\% & 0.6\% & 0.9\% &  0.9\% & 0.7\% & 0.8\%\\ 
			Phase 2 & 1\% & 0.6\% & 0.5\% & 0.6\% & 0.8\% & 0.4\% & 0.5\%\\ \hline
 	\hline
	\end{tabular} 
\end{center}
\end{table}
