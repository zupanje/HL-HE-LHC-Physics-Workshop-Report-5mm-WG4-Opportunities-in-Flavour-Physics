...
\caption{Left: Expected CMS invariant mass resolution in Phase 2 compared with Phase 1 (real data). Right:Normalized proper decay decay lenght uncertainty in 2012 data(blue) and Phase 2 Monte Carlo (red) samples}
\label{fig:CMSreso}
\end{figure}
...
Figure \ref{jpsiphiSensitivity:Contour} summarises the projected contours in the $\Delta \Gamma_s$ vs $\varphi_s$ plane for the ATLAS-CMS-(LHCB?). To be dediced!
