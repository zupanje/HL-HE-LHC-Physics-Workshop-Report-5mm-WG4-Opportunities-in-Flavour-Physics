...
A function proportional to $1/\sqrt{\epsilon D^2}$ is shown in the CMS plot to describe the $\phi_s$ uncertainty behaviour in a continuous range of the tagging power from 1.0 to 2.6 \% (CMS plot taken from \cite{CMS-PAS-FTR-18-041}).}
