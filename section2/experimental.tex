...
\caption{Left: Expected CMS invariant mass resolution in Phase 2 compared with  Right:Normalized proper decay decay lenght uncertainty in 2012 data(blue) and Phase 2 Monte Carlo (red) samples}
\label{fig:CMSreso}
\end{figure}
