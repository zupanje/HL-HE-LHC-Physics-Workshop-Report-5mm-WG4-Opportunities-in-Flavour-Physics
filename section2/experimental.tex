...
The current world average is consistent with the SM prediction~\cite{Charles:2015gya,Artuso:2015swg}, with new physics contributions of ${\cal O}(10\%)$ \td{DMS: do you mean O(0.1 rad) instead?} still allowed.
