...
The expected statistical precision on $\sin{\phi_d}$ and $\cos{\phi_d}$ are $\pm 0.06$ and $\pm 0.10$, respectively, for the LHCb Run 1 and 2 \td{define?} data samples combined.
...
For some modes such as $\Bs \to \jpsi f_0(980)$ this may be challenging, since the identification of the states in the \grpsuthree\ multiplet is not trivial. \td{JZ: check:}
