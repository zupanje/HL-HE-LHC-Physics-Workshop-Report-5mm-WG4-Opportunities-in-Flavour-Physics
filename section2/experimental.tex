...
Table \ref{jpsiphitable} summarises the expected sensitivities, compared to the ATLAS Run~1 measurements and Fig.~\ref{CMS:tag} left shows the $\delta \phi_s$ distributions .% and extrapolations to Run~2 statistics. 
