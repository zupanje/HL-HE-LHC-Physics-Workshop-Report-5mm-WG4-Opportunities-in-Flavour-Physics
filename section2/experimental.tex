...
\caption{CMS c$\tau$ uncertainty distribution in 2012 data (blue) and HL-LHC Monte Carlo (red) samples (taken from \cite{CMS-PAS-FTR-18-041}).\td{broken reference}}
\label{fig:CMSreso}
\end{center}
\end{figure}
