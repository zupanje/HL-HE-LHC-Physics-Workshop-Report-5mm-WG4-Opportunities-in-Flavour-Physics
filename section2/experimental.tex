...
of \lhcb's \upgradeone \td{keep?} but \lhcb will dominate \g measurements with \upgradetwo (300\invfb) contributing entirely towards a world average precision of
$\sim0.35\degrees$.
...
With improvements in the reconstruction of downstream tracks in the first HLT \td{define} stage, we may also be able to exploit 
