...
the same as in the LHCb Upgrade I detector, which will have a baseline foil thickness of 250 $\mu$m.
}
...
\begin{figure}[!tb]
  ...
  \caption{Extrapolation of \g sensitivity from the ADS/GLW analyses at LHCb, where disfavoured ambiguities are ignored. The expected Belle II precision on $\gamma$  at an integrated luminosity of 50 ab$^{-1}$ is shown by the horizontal grey lines.
