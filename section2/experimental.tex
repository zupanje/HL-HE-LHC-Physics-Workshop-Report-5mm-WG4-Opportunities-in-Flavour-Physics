...
\end{equation}
where $\tan\theta_c$ is the tangent of the Cabibbo angle and  ${f_{D_s}}/{f_{D^+}}$ is the ratio of decay constants.
...
%However t
These would be mitigated by an improved electromagnetic calorimeter for the \lhcb \upgradeone{b} and \upgradetwo.
