...
LHCb foresees to extend the study of $b\to c\bar{c}s$  transitions to cover  multiple independent precision measurements.  is important since it allows not simply to improve the precision of the average, but also to perform a powerful consistency check of the SM.
