...
The CMS study is based on fully simulated signal events using the same model as in the previous CMS analysis \cite{CMSPhis} and toy Monte Carlo experiments for three different tagging scenarios: $a$ where the flavour tagging performance is based on muons and 
