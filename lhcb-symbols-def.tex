...
% some extra symbols for Upgrade document
...
\def\Xibz    {\ensuremath{\Xires^0_\bquark}\xspace}
\def\Xibzbar {\ensuremath{\Xiresbar^0_\bquark}\xspace}
\def\XibPrimeMinus  {{\ensuremath{\Xires^{\prime -}_\bquark}}\xspace}
\def\XibStarMinus  {{\ensuremath{\Xires^{*-}_\bquark}}\xspace}

\def\Xiccpp  {\ensuremath{\PXi_{\cquark\cquark}^{++}}\xspace}

\newcommand{\BRof}[1]{\ensuremath{{\cal B}(#1)}\xspace}
\newcommand{\phisPP}{\ensuremath{{\phi_{s}^{\squark\squarkbar\squark}}}\xspace}
\newcommand{\BsPP}{\ensuremath{{\Bs\to\phi\phi}}\xspace}

\newcommand{\Ksmm}{\ensuremath{\KS\to\mu^+\mu^-}\xspace}
...
\def\lumunit {\ensuremath{\rm \, cm^{-2}s^{-1}}\xspace}

 \newcommand{\orm}[1]{\shortstack{{\tiny $(-)$}
  \\ [-.7ex] $#1$}}
  
   \newcommand{\orp}[1]{\shortstack{{\tiny $(+)$}
  \\ [-.7ex] $#1$}}
