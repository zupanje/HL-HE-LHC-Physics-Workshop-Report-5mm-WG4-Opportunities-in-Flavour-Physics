...
J.~Alimena$^1$, P.~Azzi$^2$, R.~Bhattacharya$^3$, E.~Boos$^4$, A.~Bragagnolo$^5$, L.~Cadamuro$^6$, F.R.~Cavallo$^7$, M.~Cepeda$^{8,9}$, K.F.~Chen$^{10}$, M.~Dinardo$^{11}$, P.~Dini$^{11}$, L.~Dudko$^4$, S.~Dutta$^3$, G.~Fedi$^{12}$, S.~Fiorendi$^{11}$, F.~Fiori$^{13}$, A.~Gilbert$^9$, L.~Guzzi$^{11}$, J.~Haller$^{14}$, K.~Hoepfner$^{15}$, J.M.~Hogan$^{16,17}$,
Sa.~Jain$^{18}$,
J.~Kieseler$^9$, T.~Klijnsma$^{19}$, R.~Kogler$^{14}$, A.~Korytov$^6$, U.~Langenegger$^{20}$, F.~Ligabue$^{13}$, S.~Malvezzi$^{11}$,
P.~Mandrik$^{21}$, P.~Matorras Cuevas$^{22}$, K.~Mazumdar$^{18}$, A.B.~Meyer$^{23}$, G.~Mitselmakher$^6$, M.~Narain$^{16}$, O.~Ozcelik$^{24,25}$, F.~Palla$^{12}$, K.~Pedro$^{26}$, M.~Perfilov$^4$, A.~Reimers$^{14}$, S.~Sarkar$^3$, A.~Savin$^{27}$, S.~Sawant$^{18}$, A.~Schmidt$^{15}$, B.~Schneider$^{26}$, K.~Skovpen$^{28}$, Y.~Takahashi$^{22}$, D~Tsiakkouri$^{29}$, R.~Venditti$^{30}$, P.~Volkov$^4$, G.~Vorotnikov$^4$, J.~Wang$^6$, W.~Zhang$^{16}$
...
$^{11}$ INFN Sezione di Milano-Bicocca, and Universit\`{a} di Milano-Bicocca, Milano, Italy\\
$^{12}$ INFN Sezione di Pisa, Pisa, Italy\\
$^{13}$ INFN Sezione di Pisa, Scuola Normale Superiore di Pisa, Pisa, Italy\\
$^{14}$ University of Hamburg, Hamburg, Germany\\
$^{15}$ RWTH Aachen University, III. Physikalisches Institut A, Aachen, Germany\\
$^{16}$ Brown University, Providence, and Bethel University, St. Paul, USA\\
$^{17}$ Bethel University, St. Paul, USA\\
$^{18}$ Tata Institute of Fundamental Research-B, Mumbai, India\\
$^{19}$ ETH Zurich - Institute for Particle Physics and 
Astrophysics (IPA), Zurich, Switzerland\\
$^{20}$ Paul Scherrer Institut, Villigen, Switzerland\\
$^{21}$ Institute for High Energy Physics of National Research Centre 'Kurchatov Institute', Protvino, Russia\\
$^{22}$ Universit\"{a}t Z\"{u}rich, Zurich, Switzerland\\
$^{23}$ Deutsches Elektronen-Synchrotron, Hamburg, Germany\\
$^{24}$ Bogazici University, Istanbul, Turkey\\
$^{25}$ Laborat\'{o}rio de Instrumenta\c{c}\~{a}o e F\'{i}sica Experimental de Part\'{i}culas, Lisboa, Portugal\\
$^{26}$ Fermi National Accelerator Laboratory, Batavia, USA\\
$^{27}$ University of Wisconsin - Madison, Madison, USA\\ 
$^{28}$ Vrije Universiteit Brussel, Brussel, Belgium\\
$^{29}$ University of Cyprus, Nicosia, Cyprus\\
$^{30}$ INFN Sezione di Bari, Bari, Italy\\
