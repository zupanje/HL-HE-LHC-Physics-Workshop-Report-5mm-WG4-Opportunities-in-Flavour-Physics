...
Better experimental information in the $2^{++}$ spectrum around 4~GeV is hence of great importance, and the $X_2$ can be searched for in $D\bar D$ and $J/\psi\omega$. So far, there is only one observed state $\chi_{c2}(3930)$  compatible with a standard charmonium assignment, and its mass is lower than what is normally expected for the $X_2$. No evidence for an additional tensor resonance qualified as an $X_2$ candidate has been observed so far.  \td{JZ: not a very clear sentence, please improve. FK: modified, how about this version? Juan, please check:} Yet, whether or not an additional $\chi_{c1}(2P)$ exists in addition to the $X(3872)$, and whether or not an additional $X_2$ exist inaddition to the $\chi_{c2}(2P)$ are actually still open questions. Searching for them will be of the utmost importance to understand the mysterious $X(3872)$~\cite{Cincioglu:2016fkm}.
