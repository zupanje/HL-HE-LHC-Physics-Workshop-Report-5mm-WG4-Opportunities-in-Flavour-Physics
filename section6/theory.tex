...
%~\cite{Maiani:2004vq}, 
where the  two quarks and  the two antiquarks are coupled to form a color singlet, see, e.g.,~\cite{Maiani:2004vq}. \Blu{The small width of states can be due to the fact that tetraquark prefer to decay into baryons, which is kinematically not accessible. Moreover, having a single heavy quark, isospin violation is expected to be less relevant than for other tetraquarks.}   Using the mass of the $X(3872)$  to fix the chromomagnetic coupling in the tetraquark model,  one can indeed accommodate both of them. Of course, this predicts other similar states with quantum numbers $(0,1,2)^+$, all expected to decay into $D_s^{(*)+} \pi^0$. The $D^{(*)} K$ mode should be open for the heavier members in the multiplet.  %  \sasa{\it I propose to list relevant decay channels for searching these other states and their present status. } 
