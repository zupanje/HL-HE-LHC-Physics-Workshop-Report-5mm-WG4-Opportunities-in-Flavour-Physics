...
\paragraph{Phenomenology}
    ...
    \Blu{Several experiments attempted to verify the SELEX result, but did not see anything in the channel reported by SELEX. There is concensus that the SELEX result in wrong.\footnote{For  discussions of reasonable values for the isospin slitting between doubly-charmed baryons within QCD$+$QED, see~\cite{Brodsky:2011zs,Karliner:2017gml}.}}
