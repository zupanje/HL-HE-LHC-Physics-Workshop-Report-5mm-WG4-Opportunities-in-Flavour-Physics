...
\hline\hline
  States/structures & Observables   & Channels & Further comments \\ \hline
  $D_{s0}^*(2317)$ & Upper limit of the width, branching fractions & $D_s^+\pi^0, D_s^{*+}\gamma$ & $\pi^0$ is difficult \\
\hline\hline
\end{tabularx}
\end{table}