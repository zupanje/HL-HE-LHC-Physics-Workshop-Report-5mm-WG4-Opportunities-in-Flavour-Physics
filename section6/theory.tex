...
The above feature, the suppression of the interactions across different diquarks and the preference for decaying into open-flavor mesons, can be qualitatively explained with a separation in space of the two diquarks due to a (tiny) potential barrier between the two~\cite{Selem:2006nd, Maiani:2017kyi,Esposito:2018cwh}. This would also make these exotic hadrons slightly larger than the standard ones ($\approx 1.3$~fm)~\cite{Esposito:2018cwh}. 
...
In the case of coupled-channel dynamics, one might also find states  that can decay into some of the open channels. That  will also qualify as hadronic molecules, if they strongly couple to any of the channels considered in the dynamical space. 
