...
Unfortunately at \lhcb, the reconstruction efficiency for the dominant $\Pchi_{\cquark 1}(1P)$ decay  to \g\jpsi decay is low, making this prediction hard to test.
 The very large data set of LHCb \upgradetwo  will allow to overcome this problem, and will be essential
...
There could exist pentaquarks of 
%the existence of 
an isospin quadruplet, and then there is the interesting possibility to find doubly charged
...
The history of $\PX(3872)$ studies illustrates well the difficulty of distinguishing between exotic and conventional explanations for a hidden-charm state.
 Therefore, it is appealing to search for  states with  an uncontroversial exotic signatures.
...
these states in the $\decay{\Pchi_{\cquark}(\Pchi_\bquark)}{\jpsi(\PUpsilon)\g}$ decay\cite{
  ...
  LHCb-PAPER-2014-031,
  LHCb-PAPER-2014-040}.
An integrated luminosity of 300\invfb will allow to probe the high-multipole contributions 
