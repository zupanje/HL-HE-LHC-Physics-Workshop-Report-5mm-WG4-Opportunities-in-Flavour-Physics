\subsection{Experimental prospects of high $p_T$ searches  relevant for $B$ anomalies}
...
\subsubsection{Prospects for leptoquark searches assuming $t$+$\tau$ and/or $t$+$\mu$ decays}
\label{sec:LQ:t+tau}
...
\subsubsection{Search for leptoquarks decaying to $\tau$ and b}
...
Figure~\ref{fig:LQ3-projection} shows an upper limit at 95\% CL on the cross section, $\sigma$, times branching fraction, $\beta$, as a 
