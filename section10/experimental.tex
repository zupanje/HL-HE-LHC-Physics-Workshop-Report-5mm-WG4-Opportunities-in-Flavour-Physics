...
The analysis uses {\tt Delphes}~\cite{deFavereau:2013fsa} event samples of simulated $pp$ collisions at a center-of-mass energy of 14 TeV, corresponding to integrated luminosities of 300 and 3000\fbinv. %
...
The blue band shows the parameter space (95\% CL) for the scalar LQ $R_2$ preferred by the $\PB$ physics 
anomalies: $\lambda = (0.95 \pm 0.50) m_{LQ} ({\rm TeV})$~\cite{Buttazzo:2017ixm,Dorsner:2016wpm}. 
