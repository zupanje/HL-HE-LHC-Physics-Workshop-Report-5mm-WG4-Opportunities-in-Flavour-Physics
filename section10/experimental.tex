...
$\tau$ lepton. 
The relevant Feynman diagrams of the signal processes at leading order (LO) are shown in \fig{LQ3-diagram}.
...
$\MGvATNLO$~\cite{aMCatNLO} for $m_{LQ}=$500, 1000, 1500, and 2000 \GeV. The branching fraction $\beta$ of the LQ to a charged
...
In both channels, two reconstructed $\tauh$ with opposite-sign charge are required, each with transverse momentum $p_{T,\tau}>50$\GeV\ and a maximum pseudorapidity  $\abs{\eta_{\tau}}<2.3$. 
...
in \fig{fig:scalarptsums} for the HL-LHC 3000 $\fbinv$ scenario.
