...
\subsubsubsection{Prospects for leptoquark searches in $t$+$\tau$ and $t$+$\mu$ decays} {\color{red} [JAJ]}
...
The signature of a $W^\prime$ is considered similar to a high-mass W boson (see Fig.~\ref{fig:feynman}). 
...
The sensitivity to weaker couplings extends significantly. {\color{red}\bf[Unclear]}
