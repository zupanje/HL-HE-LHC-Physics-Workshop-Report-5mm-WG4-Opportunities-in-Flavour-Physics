...
To generate sufficient amount of CP violation, such mass mixing needs to be sizeable. Let us consider its effect on the quark Yukawa coupling~\footnote{Similar, but CP-preserving, modifications are also generated in the couplings of the Higgs boson to the SM gauge fields and the Higgs self-interactions.}:
