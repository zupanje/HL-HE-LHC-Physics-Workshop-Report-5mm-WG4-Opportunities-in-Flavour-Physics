...
%\td{cite WG2}, 
and searches for composite resonances (further details can be found in WG3 write-up).
%\td{cite WG3}.
...
\subsubsection{Conclusions regarding high $p_T$ probes of flavour anomalies}
