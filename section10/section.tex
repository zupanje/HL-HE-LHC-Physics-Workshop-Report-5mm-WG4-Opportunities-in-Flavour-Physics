...
%{\bf Authors: Martin Bauer, Adrian Carmona, Geraldine Servant?} 
...
% (for further details see the discussion in the WG2 write-up \td{cite}),
%\td{cite WG2}, 
...
% (further details can be found in WG3 write-up \td{cite}). 
...
%\td{need to shorten}
{\it\small Authors (TH): Adri\'an Carmona.}\\
...
%{\bf Authors: Martin Bauer, Adrian Carmona} (anticipated length 2 pages)
...
%{\bf Authors: Cedric Weiland?}(anticipated length 2 pages)
%\td{missing}
