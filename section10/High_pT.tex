...
generically implies a sizeable signal in $p p \to \tau^+ \tau^-$ production at high-$p_T$. For realistic flavour structures, in which $b \to c$ transition is $\mathcal{O}(V_{cb})$ suppressed compared to $b \to b$, one expects rather large $b b \to \tau \tau$ NP amplitude. 
...
\caption{ \small \Blu{Present constraints and HE and HL-LHC reach in the $m_{\rm LQ}-g_3$ plane for scalar leptoquark $S_3$ (left), and vector leptoquark $U_1$ (right). %In the gray region of parameter space
%represents the parameter space where 
%the expected total number of events for leptoquark production in the $b\tau$ channel will be larger than 10 at 3~TeV CLIC with $3\, {\rm ab}^{-1}$ of luminosity; the red region is the present exclusion from LHC,
combining pair production (vertical bound) and $\tau\tau$ searches; the red dashed line is the projected reach at HL-LHC. The green and yellow bands are the $1\sigma$ and $2\sigma$ preferred regions from the fit to $B$ physics anomalies. The second coupling required to fit the anomaly does not enter in the leading high-$p_T$ diagrams but is relevant for fixing the preferred region shown in green, for more details see Ref.~\cite{Buttazzo:2017ixm}. TO BE FINISHED
