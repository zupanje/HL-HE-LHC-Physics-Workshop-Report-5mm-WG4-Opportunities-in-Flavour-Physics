...
\caption{ \small Comparison between the reach of CLIC and LHC in the $m_{\rm LQ}-g_3$ plane for scalar leptoquark $S_3$ (left), and vector leptoquark $U_1$ (right). In the gray region of parameter space
...
Tree-level mediators can also be light, if sufficiently weakly coupled, but can also be much heavier---possibly beyond the reach of the LHC. 
