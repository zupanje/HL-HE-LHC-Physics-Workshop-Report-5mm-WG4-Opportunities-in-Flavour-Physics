...
%It is found that t
the interference \Blu{of the} $CP$-violating contribution can affect $K_S \to \mu^+ \mu^-$ decay up to $\mathcal{O}(60)\%$. \Blu{This is of current interest given the possible discrepancies with the SM in $\varepsilon^\prime/\varepsilon$~\cite{Pallante:1999qf,Buras:2015yba,Buras:2015xba,Kitahara:2016nld,Gisbert:2017vvj}.}
