...
Ref. \cite{Borsato:2018tcz} presented a feasibility study for the modes in Eq. (\ref{eq:limits}), taking $K^+ \to  \pi^+ \mu^\pm e^\mp$ as a benchmark. The expected reach is displayed in Fig. \ref{fig:K_LFV} as a function of the integrated luminosity and for different scenarios of detector performance. This shows that LHCb \upgradetwo could update all the existing limits \td{also $\pi^0$ mode?}, a result that per se already makes these searches promising. 
