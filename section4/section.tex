...
In a similar way, $\CP$ asymmetry of $B_{d,s} \to \mu^+ \mu^- $ has been studied  \cite{DeBruyn:2012wk,Buras:2013uqa}. However, for $B_s$ system the situation differs substantially from $K_S$, since 
