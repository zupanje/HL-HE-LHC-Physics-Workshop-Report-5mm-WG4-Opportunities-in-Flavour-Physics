...
\td{check:} 
In the SM, $ A_{CP} (K_S \to \mu^+ \mu^-)^{\textrm{SM}}_{D,-D} = \mathcal{O}(0.7)\times D$ is predicted in the case of $D' = -D$ \cite{Chobanova:2017rkj}. 
...
but is also sensitive to a new $CP$-violating phase beyond the SM.
