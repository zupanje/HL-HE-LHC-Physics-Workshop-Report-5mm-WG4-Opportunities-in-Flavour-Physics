...
\td{which upgrades?} LHCb Upgrade and Phase-II Upgrade are expected to be able to probe short-distance physics 
...
The branching ratio for $K_L \to e^+ e^- $ is dominated by the double logarithm contribution,  $\propto \log ^2 (m_e/m_K)$. \td{not clear why two predictions, please elaborate:} The
measured $\mathcal{B}(K_L \to \mu^+ \mu^- )$ then predicts  
