...
The branching ratio for $K_L \to e^+ e^- $ is dominated by the double logarithm contribution,  $\propto \log ^2 (m_e/m_K)$. \td{not clear why two predictions, please elaborate:} . The subdominant   local term is fixed,  up  to a two-fold ambiguity, from the
